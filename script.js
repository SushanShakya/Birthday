...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date("Aug 7, 2025 00:00:00").getTime(),
...
new TypeIt("#teks1", {
  strings: [
    ...
    "Every moment with you is a gift I never want to end.",
    "Your smile lights up even the darkest days.",
    "I’m so lucky to have you by my side.",
    "Here’s to more laughs, hugs, and unforgettable memories. ❤️",
  ],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: [
    "To the most beautiful soul I know, happy birthday! 💖",
    "You make life sweeter just by being in it.",
    "Thank you for being my peace, my chaos, and everything in between.",
    "Let’s make today as magical as you are.",
